    ...
    <div ng-controller="homeController">
        ...
        <div id="content">
            ...
            <div class="innerAll">
                <div class="row" style="margin-left: 17px;margin-right: 23px;">
                    <div class="timeline-cover">
                        <div id="map"
                             style="position: absolute; left: 0px; top: 0px; overflow: hidden; width: 100%; height: 20%; z-index: 0; transform: translateZ(0px); background-color: rgb(229, 227, 223);"></div>
                                ...
                                <div class="container-1">
                                    ...
                                    <section class="like-box">
                                        ...
                                        <div class="fb-like fb_iframe_widget"
                                             data-href="https://www.facebook.com/Lozi.vn" data-layout="standard"
                                             data-action="like" data-show-faces="true" data-share="false"
                                             fb-xfbml-state="rendered"
                                             fb-iframe-plugin-query="action=like&amp;app_id=600859170003466&amp;href=https%3A%2F%2Fwww.facebook.com%2FLozi.vn&amp;layout=standard&amp;locale=en_US&amp;sdk=joey&amp;share=false&amp;show_faces=true">
                                            <span style="vertical-align: bottom; width: 450px; height: 57px;"><iframe
                                                        name="f18e1a7ff" width="1000px" height="1000px" frameborder="0"
                                                        allowtransparency="true" scrolling="no"
                                                        title="fb:like Facebook Social Plugin"
                                                        src="http://www.facebook.com/v2.0/plugins/like.php?action=like&amp;app_id=600859170003466&amp;channel=http%3A%2F%2Fstatic.ak.facebook.com%2Fconnect%2Fxd_arbiter%2F7r8gQb8MIqE.js%3Fversion%3D41%23cb%3Df10ee99eb8%26domain%3Dlozi.vn%26origin%3Dhttp%253A%252F%252Flozi.vn%252Ff2cd1837a%26relation%3Dparent.parent&amp;href=https%3A%2F%2Fwww.facebook.com%2FLozi.vn&amp;layout=standard&amp;locale=en_US&amp;sdk=joey&amp;share=false&amp;show_faces=true"
                                                        style="border: none; visibility: visible; width: 450px; height: 57px;"
                    ...
                    <div class="col-lg-9 col-md-8">
                        ...
                        <div class="blc-row" style="width: 282px;">
                            ...
                            <div id="menu" class="hidden-print hidden-xs sidebar-default sidebar-brand-primary"
                                 style="position: absolute;height: 380px;background: #F9F3F3;">
                        ...
                        <div class="blc-row">
                            <div class="widget border-none bg-none widget-pinterest active">
                                <div class="widget-body bg-none padding-none">
                                    <a href="https://scontent-a-sjc.xx.fbcdn.net/hphotos-xpa1/v/t1.0-9/10710982_761458170594432_5559789937541518617_n.jpg?oh=12aae3acfa42afe5bfd5e5f7d1c49b83&oe=55023312"
                                       data-toggle="prettyPhoto" class="thumb">
                                        <img src="https://scontent-a-sea.xx.fbcdn.net/hphotos-xpa1/v/t1.0-9/10710982_761458170594432_5559789937541518617_n.jpg?oh=12aae3acfa42afe5bfd5e5f7d1c49b83&oe=55023312"
                                             alt="photo"/>
                                    </a>
                                    ...
                                    <div class="description  meta">
                                        <div class="hover-blue">
                                            <div class="title" id="yui_3_11_0_3_1419092456557_1068">
                                                <a data-track="photo-click" href="shop.html?lang=en"
                                                   title="London 7 - Mirror (Explored at #6)" class="title">London 7 -
                                                    Mirror (Explored at #6)</a>
                                            </div>
                                            <div class="attribution-block" style="height: 7px;margin-top: 6px;">
    										<span class="attribution"><span>bởi </span>
    										<a data-track="owner" href="/photos/94437781@N05" title="Wesley Nagelmaker"
                                               class="owner">Wesley Nagelmaker</a></span>
                                            </div>
                                        </div>
    								<span class="inline-icons" style="font-size: 11px;">
    									<img width="12" height="12" alt="[★]"
                                             src="https://s.yimg.com/pw/images/spaceball.gif"
                                             style="background: rgba(150, 25, 25, 0) url(https://s.yimg.com/pw/images/sprites/icons/fav.png) no-repeat scroll center;background-size: contain;margin-right: -3px;vertical-align: top;margin-top: -1;width: 15px;height: 15px;">
    									<a data-track="favorite" href="#" class="rapidnofollow fave-star-inline canfave"
                                           onMouseOver="this.style.color='white'"
                                           onMouseOut="this.style.color='white'"
                                           title="Thêm ảnh này vào ảnh yêu thích của bạn?">
                                            <span class="fave-count count" style="margin-right: 3px;">99+</span>
                                        </a>
    									<i class="fa fa-smile-o" style="color: white;"></i>
    									<a title="Lời bình" href="#"
                                           class="rapidnofollow comments-icon comments-inline-btn"
                                           onMouseOver="this.style.color='white'"
                                           onMouseOut="this.style.color='white'">
                            ...
                            <div class="widget border-none bg-none widget-pinterest">
                                <div class="widget-body bg-none padding-none">
                                    <a href="#popup-region" data-toggle="modal" class="thumb">
                                        <img src="assets/img/images/KXnECf3C7iWSKpwDrCMQPOd4b2DWp5da-b-320.jpg"
                                             alt="photo"/>
                                    </a>
                                    ...
                                    <div class="description">
                                        ...
                                        <button class="btn btn-stroke btn-circle btn-danger"><i
                                ...
                                <div class="widget-body bg-none padding-none">
                                    ...
                                    <div class="description  ">
                                        ...
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias,
                                            consequuntur iure commodi omnis at pariatur quis hic mollitia impedit
                                            error.</p></div>
                                </div>
                            </div>
                            <div class="widget border-none bg-none widget-pinterest">
                                        ...
                                        <div class="hover-blue">
                                            <div class="title" id="yui_3_11_0_3_1419092456557_1068">
                                                <a data-track="photo-click"
                                                   href="/photos/94437781@N05/15417955443/in/explore-2014-12-16"
                                                   title="London 7 - Mirror (Explored at #6)" class="title">London 7 -
                                                    Mirror (Explored at #6)</a>
                                            </div>
                                            <div class="attribution-block" style="height: 7px;margin-top: 6px;">
                                            ...
                                            <div class="media-body">
                                                <h5 class="margin-none">
                                                    <a href="" class="text-inverse"
                                                       style="margin-top: -10px;margin-left: -16px;">Social Admin
                                                        Released</a>
                                                </h5>

                                                <div class="btn-group-vertical btn-group-sm" style="margin-top: 13px;">
                                                    <a href="" class="btn btn-primary"
                                                       style="width: 71px;height: 28px;margin-top: -24px;">
            ...
            <div id="footer">
                ...
                <!--  Copyright Line -->
                <div class="copy">&copy; 2012 - 2014 - <a href="http://www.mosaicpro.biz">MosaicPro</a> - All Rights
                    Reserved. <a href="http://themeforest.net/?ref=mosaicpro" target="_blank">Purchase Social Admin
                        Template</a> - Current version: v2.0.0-rc8 / <a target="_blank"
                                                                        href="../assets/../../CHANGELOG.txt?v=v2.0.0-rc8">changelog</a>
                </div>
                <!--  End Copyright Line -->
